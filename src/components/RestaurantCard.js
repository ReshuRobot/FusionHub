...
const RestaurantCard = ({resData}) => {
    // console.log("inrestarntcard",resData);
    // console.log("nae",resData?.info?.name)
      ...
      return (
        <div className="res-card">
          ...
          <div className="res-info">
            ...
            <div className="res-cuisine">{cuisines.slice(1,5).join(",")}</div>
            ...
            {avgRating}</div>
            <div className="res-deliverytime">  <span className="dot">·</span>{deliveryTime} min</div>
            </div>
          </div>
        </div>
      );
